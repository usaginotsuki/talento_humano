...
class SolicitudController extends Controller {
	...
	{
        return view ('solicitudLogin.login');
	}
	...
	{       
		...
		if(empty($docentes)){
           return view ('guias.login')->with('title', 'Auntenticación incorrecta!')->with('subtitle', 'Ingrese el usuario y clave correctas.');
			...
			return view('solicitudLogin.index', [
				'periodo' => $periodo,
				'docente' => $docentes,
				'count' => $count
	...
	public function crearSolicitudIndex(){
...
/*Obtienes guias de materia seleccionada */
   ...
   public function createSolicitudSeleccion(Request $request)
   {
   ...
   public function guardarSolicitud(Request $request){
	   //obtiene el id de docente 
		...
		return redirect('solicitud/listarGuias/'.$materia);
   }
