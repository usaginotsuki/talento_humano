             ...
             <form action="{{url('/reporte/horario/docente')}}" method="post">
                 ...
                 <div class="card border-primary mb-3">
                     ...
                     <div class="card-body text-primary">
                         ...
                         <br>
                         <select type="input" class="form-control" id="PER_CODIGO" name="DOC_CODIGO" placeholder="Laboratorio"  required>
                             @foreach ($docentes as $docente)
                                 @if($docente->DOC_CODIGO == $valores['DOC_CODIGO'])
                                     <option value="{{ $docente->DOC_CODIGO }}" selected>{{$docente->DOC_APELLIDOS}} {{$docente->DOC_NOMBRES}}</option>
                                 @else
                 ...
                 <div class="card-body text-info">
                     <form>
                         ...
                         <div class="custom-control custom-radio mb-3">
                             @if (isset($horario))
                             <input type="radio" class="custom-control-input" id="textoFondo" name="opts" onChange="changeText()" checked>
                             @else
