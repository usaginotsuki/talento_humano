...
<div class="container-fluid">
    ...
    <p id="sala">
       <span class="h4">REPORTE: 
            <span style="font-weight: 300;">EVENTOS OCASIONALES</span>
        </span>
        <br>
    ...
    <thead>
        ...
        <tbody>
            ...
            @if (count($data)>0)
                    @foreach ($data as $eve)
                        <tr>
                            ...
                            <td scope="row">{{$eve -> MAT_ABREVIATURA}}</td>
                            <td scope="row">{{$eve -> DOC_NOMBRE}}</td>
                            <td scope="row" align="center">{{$eve -> CON_DIA }}</td>
                            <td scope="row" align="center">{{$eve -> CON_HORA_ENTRADA}}</td>
                            <td scope="row" align="center">{{$eve -> CON_HORA_SALIDA}}</td>
                            <td scope="row" align="center">{{$eve -> CON_NUMERO_HORAS}}</td>
                            <td scope="row">{{$eve-> CON_NOTA}}</td>
                        </tr>
                        <?php $total+=$eve -> CON_NUMERO_HORAS ?>
                    @endforeach     
            @else
                <table align="center" >
                    <tr>
            ...
            @endif        
            <tr>
                <td scope="row" colspan="6" style="text-align: right;"><h3>TOTAL: </h3></td>
                <td scope="row" align="center"><h3>{{$total}}</h3></td>
                <td scope="row"></td>
            </tr>
        </tbody> 
</table>
