...
#header { position: fixed; left: 30pt; top: -135px; right: 15pt;  background-color:; text-align: center;  font-family:sans-serif; font-size:11pt; }
#footer { position: fixed; left: 30pt; bottom: -235px; right: 15px; height: 150px; }
        ...
        <table  border="0px"  >
                <thead >
                    <tr>
                      ...
                      <td scope="row" id="izquierda"width="30%">: EVENTOS OCASIONALES  </td>
       ...
       <table>
         <tbody >
              <tr>
                    ...
                    <td style="text-align: center; vertical-align: middle;" scope="row" width="38%" > <b>DOCENTE</b> </td>
                    <td style="text-align: center; vertical-align: middle;" scope="row" width="5%" > <b>HORAS</b> </td>             
                    <td style="text-align: center; vertical-align: middle;" scope="row" width="10%" > <b>NOTA</b> </td>
              </tr> 
            <?php $total=0 ?>
            @for ($i = 0; $i < count($data); $i++)
              <tr>
                      <td  scope="row" id="centrado" width="4%">{{$i+1}}</td>
                      ...
                      <td style="text-align: left; vertical-align: middle;" scope="row"id="centrado"width="38%"> {{$data[$i] -> DOC_NOMBRE}}</td>
                      <td style="text-align: center; vertical-align: middle;" scope="row"id="centrado"width="5%">{{$data[$i] -> CON_NUMERO_HORAS}}</td>  
                      <td style="text-align: left; vertical-align: middle;" scope="row"id="centrado"width="10%">{{$data[$i] -> CON_NOTA}}</td>  
                      <?php $total+=$data[$i] -> CON_NUMERO_HORAS ?>
              </tr>
            @endfor
            <tr>
                      <td scope="row" style="text-align: right;" colspan="5">TOTAL: </td>
                      <td style="text-align: center; vertical-align: middle;" scope="row"id="centrado">{{$total}}</td>  
                      <td> </td>  
              </tr> 
         </tbody>   
      </table>
