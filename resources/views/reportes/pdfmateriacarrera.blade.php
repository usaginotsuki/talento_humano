       ...
       <table>
         <tbody >
              <tr>
                    ...
                    <td style="text-align: center; vertical-align: middle;" scope="row"  width="4%"> <b>NRC</b></td>
              ...
              <tr>
                      ...
                      <td style="text-align: left; vertical-align: middle;" scope="row" id="centrado" width="10%">{{$materias[$i] -> MAT_NOMBRE}}</td>
                      <td style="text-align: left; vertical-align: middle;"  scope="row" id="centrado" width="4%">{{$materias[$i]->MAT_NRC}}</td>
                      <td   style="text-align: left; vertical-align: middle;" scope="row" id="centrado" width="18%"> {{$materias[$i] -> docente->DOC_NOMBRES.' '.$materias[$i]->docente->DOC_APELLIDOS}}</td>
                      <td  style="text-align: left; vertical-align: middle;" scope="row" id="centrado" width="4%"> {{$materias[$i] -> MAT_CREDITOS}}</td>
